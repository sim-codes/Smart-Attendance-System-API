    ...
    public partial class InitialPhase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Classrooms", x => x.ClassromId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "CourseId");
                    table.ForeignKey(
                        name: "FK_ClassSchedules_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId");
                    table.ForeignKey(
                        name: "FK_ClassSchedules_Level_LevelId",
                        column: x => x.LevelId,
                        principalTable: "Level",
                        principalColumn: "LevelId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassSchedules_DepartmentId",
                table: "ClassSchedules",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassSchedules_LevelId",
                table: "ClassSchedules",
                column: "LevelId");
